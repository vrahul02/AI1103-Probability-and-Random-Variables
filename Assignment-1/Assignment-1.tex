...
\newline
\begin{enumerate}
\item ${{5}\choose{4}}\left(\frac{4}{5}\right)^4\left(\frac{1}{5}\right)$
\item $\left(\frac{4}{5}\right)^4\left(\frac{1}{5}\right)$
\item ${{5}\choose{1}}\left(\frac{4}{5}\right)^4\left(\frac{1}{5}\right)$
\item None of these 
\end{enumerate}
\section*{Solution}
Being 'swimmer' and being 'non swimmer' are mutually exclusive,
\begin{itemize}
\item Probability of 'non swimmer' = q = $\frac{1}{5}$
\item Probability of 'swimmer' = p = 1- q = $\frac{4}{5}$
\item Total number of students = n = 5
\item Total number of swimmers = l = 4
\end{itemize}
...
\begin{align}
\Pr\brak{K=l} = {{n}\choose{l}}(q)^{n-l}(p)^{l}
\end{align}
\begin{align}
\Pr\brak{K = 4}={{5}\choose{4}}\left(\frac{1}{5}\right)^{1}\left(\frac{4}{5}\right)^{4}
\end{align}
As per the property of permutation and combination,
\begin{align}
{{n}\choose{l}}={{n}\choose{n-l}}\\
\implies\Pr\brak{K = 4}={{5}\choose{1}}\left(\frac{1}{5}\right)^{1}\left(\frac{4}{5}\right)^{4}\\
...
\newline
\includegraphics[width=\columnwidth,scale=0.9]{Assignment-1.png}
\end{document}