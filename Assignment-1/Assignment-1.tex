...
\newline
\begin{enumerate}
\item ${\comb{5}{4}}\left(\frac{4}{5}\right)^4\left(\frac{1}{5}\right)$
\item $\left(\frac{4}{5}\right)^4\left(\frac{1}{5}\right)$
\item ${\comb{5}{1}}\left(\frac{4}{5}\right)^4\left(\frac{1}{5}\right)$
\item None of these 
\end{enumerate}
\section*{Solution}
...
\begin{align}
\Pr\brak{K=l} = {\comb{n}{l}}(q)^{n-l}(p)^{l}
\end{align}
\begin{align}
\Pr\brak{K = 4}={\comb{5}{4}}\left(\frac{1}{5}\right)^{1}\left(\frac{4}{5}\right)^{4}
\end{align}
As per the property of permutation and combination,
\begin{align}
{\comb{n}{l}}={\comb{n}{n-l}}\\
\implies\Pr\brak{K = 4}={\comb{5}{1}}\left(\frac{1}{5}\right)^{1}\left(\frac{4}{5}\right)^{4}\\
